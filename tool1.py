...
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [1] TDS TIKTOK [V1]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [2] TDS TIKTOK [V2]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [3] TDS TIKTOK & TIKTOK NOW"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [4] TDS FACEBOOK FULL JOB [ĐHP]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [5] TDS INSTAGRAM AOTU PROXY"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [6] TOOL ĐỔI MK TĐS"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═══════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║  Tool Tương Tác Chéo  ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═══════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [7] TTC TIKTOK [OFF]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [8] TTC FACEBOOK [ĐHP]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [9] TOOL TTC PRO5"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [10] TOOL TTC INSTAGRAM"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║  Tool Spam Sms      ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [11] TOOL SPAM SMS V1"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [11] TOOL SPAM SMS V2"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║  Tool Đào Mail      ║"))
print (Colorate.Diagonal(Colors.white_to_black,"╚═════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [13] TOOL ĐÀO MAIL"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [14] TOOL ĐÀO MAIL FULL MAIL"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [15] TOOL CHECK LIVE\DIE"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [16] TOOL CHECK VALID"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [17] TOOL REG ACC GARENA [NEW] "))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║  Tool Facebook      ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [18] TOOL BUFF LIKE "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [19] KẾT BẠN FACEBOOK GỢI Ý"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [20] SHARE ẢO COOKIE "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [21] SHARE ẢO TOKEN"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [22] TOOL BUFF VIEW STR"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [23] TOOL NUÔI FACEBOOK"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Đào & Check Proxies ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [24] TOOL CHECK LIVE\DIE [V1] "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [25] TOOL CHECK LIVE\DIE [V2 SIÊU VIP]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [26] TOOL ĐÀO PROXY [V1]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [27] TOOL ĐÀO PROXY [V2]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [28] TOOL ĐÀO PROXY [V3]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [29] TOOL ĐÀO PROXY [V4 SIÊU VIP]"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Spam Messenger      ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [30] TOOL NHÂY CÓ DẤU  "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [31] TOOL NHÂY KHÔNG DẤU "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [32] TOOL NHÂY RÉO TÊN TRONG BOX "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [33] TOOL NHÂY CODE LAG "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [34] TOOL TREO SỚ "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [35] TOOL NHÂY DISCORD"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Encode & Dec        ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [36] TOOL DEC Hyperion_Deobf"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [37] TOOL DEC Kramer-Specter_Deobf"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [38] TOOL dump_marshal"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [39] TOOL Convert_Marshal-PYC"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [40] TOOL ENCODE MZB"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [41] TOOL ENCODE EMOJI "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [42] TOOL ENCODE EJULY-DUYKHANH"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [43] TOOL ENCODE BY MEO [VIP]"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Aotu Golike         ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [44] Tool Auto TikTok"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [45] Tool Auto TikTok [OFF] "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [46] Tool Auto TikTok Tự Động [OFF] "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [47] Tool Auto Instagram "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [48] Tool Auto Twitter"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [49] Tool Auto Youtube [OFF]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [50] Tool Auto Thread [OFF]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [51] Tool Auto Linkedin [OFF]"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [52] Tool Auto Shoppe [OFF] "))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔═════════════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Của Các Idol Khác   ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚═════════════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [53] TOOL VLONG ZZ"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [54] TOOL TRỊNH HƯỚNG"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [55] TOOL MEOWMEOW"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [56] TOOL HDT-TOOL"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [57] TOOL LKZ TOOL"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [58] TOOL JIRAY TOOL"))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Profile 5  ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [59] Tool Buff Member Facebook"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [60] Tool Get Cookie Page Thường & Page Pro5"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [61] Tool Chuyển QTV Pro5"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [62] Tool Follow Page Pro5"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [63] TOOL REG PAGR PRO5 + UP AVT | ĐA LUỒNG"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [64] Tool Rút Gọn Link                       "))       
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [65] Get Phản Hồi Từ Link                     "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [66] Lọc Link Từ File                         "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [67] TOOL REG ACC FACEBOOK                    "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [68] TOOL CHUYỂN QUYỀN + CHẤP NHẬN ADMIN PAGE "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [69] TOOL KÍCH HOẠT PAGE                      "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [70] TOOL GET TOKEN FB                        "))
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
print (Colorate.Diagonal(Colors.black_to_white, "╔════════════════╗"))
print (Colorate.Diagonal(Colors.red_to_white, "║Tool Tiện ích   ║"))
print (Colorate.Diagonal(Colors.white_to_black, "╚════════════════╝"))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [71] TOOL DOSS WEB VIP         "))
print (Colorate.Diagonal(Colors.green_to_white, "[🇻🇳] => Nhập Số [00] Thoát Tool                               "))   
print (Colorate.Diagonal(Colors.green_to_cyan, "███████████████████████████████████████████████████████████████"))
...
if chon == '2':
    exec(requests.get('https://raw.githubusercontent.com/levantienmc09-code/letien09/refs/heads/main/tdsv2').text)
if chon == '3' :
